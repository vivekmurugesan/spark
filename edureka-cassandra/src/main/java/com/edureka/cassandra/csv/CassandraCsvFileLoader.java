 ...
 *
 */
public class CassandraCsvFileLoader {
	...
	public static void main(String[] args) throws IOException {
		...
		CassandraCsvFileLoader parser = new CassandraCsvFileLoader();
		//parser.parseFile("src/main/resources/sample-video-stat.csv");
		parser.processAllFiles();
	}
	
	public CassandraCsvFileLoader() {
	}
	
	public CassandraCsvFileLoader(String directory) {
	...
	public void parseAndProcessFile(String fileName, String regionName) throws IOException {
		...
		for(CSVRecord record : csvRecords) {
			...
			try {
				...
				this.client.insertDataFrom(videoDetails);
